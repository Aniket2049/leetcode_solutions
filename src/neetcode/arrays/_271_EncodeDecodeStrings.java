...
//		Output:["neet","code","love","you"]
		...
		String encoded = new _271_EncodeDecodeStrings().encode(input);
		List<String> decoded = new _271_EncodeDecodeStrings().decode(encoded);
...
//		Output: ["we","say",":","yes"]
		...
		encoded = new _271_EncodeDecodeStrings().encode(input);
		decoded = new _271_EncodeDecodeStrings().decode(encoded);
		System.out.println(encoded);
		System.out.println(Arrays.toString(decoded.toArray()));
